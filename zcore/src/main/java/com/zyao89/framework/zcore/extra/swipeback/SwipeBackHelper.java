...
public class SwipeBackHelper extends Handler
{
    ...
    /**
     * @param ISlideBackManager
     */
    public SwipeBackHelper(ISlideBackManager ISlideBackManager)
    {
        if (ISlideBackManager == null || !(ISlideBackManager instanceof Activity))
        {
            throw new RuntimeException("Neither IISlideBackManager nor the method 'getSlideActivity()' can be null!");
        }

        mActivity = (Activity) ISlideBackManager;
        mIsSupportSlideBack = ISlideBackManager.supportSlideBack();
    ...
    class ViewManager
    {
        ...
        private boolean addViewFromPreviousActivity()
        {
            ...
            mPreviousActivity = ActivityManager.getInstance().getPreviousActivity();
            ...
            if (mPreviousActivity instanceof ISlideBackManager &&
                    !((ISlideBackManager) mPreviousActivity).canBeSlideBack())
            {
                mPreviousActivity = null;
                mPreviousContentView = null;
                return false;
